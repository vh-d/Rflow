...
There are three building blocks of **rflows** (DAGs connecting nodes through dependency relations):

* **nodes** (aka targets) represent your data objects such as R values, db tables, spreadsheets, files, etc...
* **environments** (for nodes) serves as containters for objects. A database is a container for tables.
