...
A library for creating and executing DAGs, everything is stored (persistent) so you can restart worflows where it failed, support for R, SQL, (Python and Julia on  the roadmap).
